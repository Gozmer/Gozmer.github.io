...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210902_philippeverspeek_fd238ca20db66bb91782_20210903110814_archive.zip';
	const ARCHIVE_SIZE		 = '90832067';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fd238ca-03110814';
    const SECONDARY_PACKAGE_HASH = '0107d3b-03110814';
	const VERSION			 = '1.4.2';
